...
class RestSrvServiceClient
{
    ...
    private static function assertInitialized()
    {
        if (empty(self::$sysId) &&
            ...
            throw new \RuntimeException(
                'RestSrvServiceClient is not initialized, ' .
                'please specify application key ' .
                'with RestSrvServiceClient::initialize.'
            );
        }
    }
    ...
    private static function log($unionid, $key, $data)
    {
        ...
        __LOG_MESSAGE($data, "RestSrvServiceClient($unionid)::$key");
    }
